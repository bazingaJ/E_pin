...
#define STARTPOINT CGPointMake(EPScreenW-40, EPScreenH-90)
...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        // add the "Add" Button.
        _addButton = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"快捷按钮"]
                                       highlightedImage:[UIImage imageNamed:@"快捷按钮"]
                                           ContentImage:nil
...
- (void)quadCurveMenuItemTouchesEnd:(QuadCurveMenuItem *)item
{
    ...
    // rotate "add" button
    float angle = self.isExpanding ? -M_PI_4*3 : 0.0f;
