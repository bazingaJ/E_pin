...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0)
    {
        ...
        if (!cell1)
        {
            ...
            cell1.firstView.width = WIDTH(145.0, 320);
            cell1.secondView.width =WIDTH(145.0, 320);
            cell1.BGView.width = WIDTH(145.0, 320);
        }
        
        NSArray *Arr = self.getDataArr[1];
        EPMainModel *data =  Arr[indexPath.row];
        NSLog(@"111111111%f,,,,,>>>>%f",cell1.firstView.bounds.size.width,cell1.BGView.width);
        UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:cell1.firstView.bounds byRoundingCorners:UIRectCornerTopLeft | UIRectCornerTopRight cornerRadii:CGSizeMake(10, 10)];
        CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
        maskLayer.frame = cell1.firstView.bounds;
        maskLayer.path = maskPath.CGPath;
        cell1.firstView.layer.mask = maskLayer;
        ...
        UIBezierPath *maskPath1 = [UIBezierPath bezierPathWithRoundedRect:cell1.secondView.bounds byRoundingCorners:UIRectCornerTopLeft | UIRectCornerTopRight cornerRadii:CGSizeMake(10, 10)];
        CAShapeLayer *maskLayer1 = [[CAShapeLayer alloc] init];
        maskLayer1.frame = cell1.secondView.bounds;
        maskLayer1.path = maskPath1.CGPath;
        cell1.secondView.layer.mask = maskLayer1;
    ...
    else if (indexPath.section == 1)
    {
        ...
        EPMainModel *data =  Arr[indexPath.row];
        NSLog(@"222222222%f",cell1.firstView.bounds.size.width);
        UIBezierPath *maskPath2 = [UIBezierPath bezierPathWithRoundedRect:cell1.firstView.bounds byRoundingCorners:UIRectCornerTopLeft | UIRectCornerTopRight cornerRadii:CGSizeMake(10, 10)];
        CAShapeLayer *maskLayer2 = [[CAShapeLayer alloc] init];
        maskLayer2.frame = cell1.firstView.bounds;
        maskLayer2.path = maskPath2.CGPath;
        cell1.firstView.layer.mask = maskLayer2;
        ...
        UIBezierPath *maskPath3 = [UIBezierPath bezierPathWithRoundedRect:cell1.secondView.bounds byRoundingCorners:UIRectCornerTopLeft | UIRectCornerTopRight cornerRadii:CGSizeMake(10, 10)];
        CAShapeLayer *maskLayer3 = [[CAShapeLayer alloc] init];
        maskLayer3.frame = cell1.secondView.bounds;
        maskLayer3.path = maskPath3.CGPath;
        cell1.secondView.layer.mask = maskLayer3;
